...
1. **Create the test project**
   - In Visual Studio select `Add -> New Project -> xUnit Test Project`.
   - Name the project `FlashEditor.Tests` and target **.NET 9**.
...
5. **Running the tests**
   ...
   - The .NET 9 SDK must be installed for `dotnet test` to compile and run the projects.
