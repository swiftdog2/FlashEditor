...
| `index-survey/00-WORKLIST.md`, and my own framing of it | Index 8 gates indexes 13 and 32, both holding sprite-format payloads | Index 13 is **not** sprite format. It holds `Class197` font metrics read by `Class119_Sub1.method2182`, and none of its 25 groups parses as a sprite set. Index 32 is fed by the sprite decoder but is **mixed**: 5 of 26 groups are 256-frame glyph sheets, 21 are JPEG ending `FF D9`. `InterfaceSettings.java:73-74` picks between index 32 and 34 for that role. |
