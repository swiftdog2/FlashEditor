...
- **Smart width.** `method1239` (our `ReadSmart`) encodes -64..63 in one byte and -49152..16383 in two, and the ranges overlap - the same delta has two encodings. Record which width was used.
