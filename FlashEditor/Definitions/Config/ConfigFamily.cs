...
namespace FlashEditor.Definitions.Config {
    ...
    public sealed class ConfigFamily {
        ...
        /// </summary>
        /// <remarks>
        ///     Ten of index 2's thirty-five groups. Seven derive from <see cref="ConfigDefinition"/>
        ///     and three predate it; the two shapes differ only in what they keep per opcode, which
        ///     <see cref="ConfigOpcodeRow.Detail"/> covers.
        /// </remarks>
        public static readonly IReadOnlyList<ConfigFamily> Modelled = new[] {
